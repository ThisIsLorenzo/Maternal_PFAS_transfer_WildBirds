...
```{r}
lod_plotA <- hist(dat$LOD_A, main = "Distribution of LOD values (adults)", xlab = "LOD Values", ylab = "Frequency")
lod_plotB <- hist(dat$LOD_P, main = "Distribution of LOD values (progeny)", xlab = "LOD Values", ylab = "Frequency")
